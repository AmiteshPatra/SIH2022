...
contract Model {
    ...
    function getRawProductDetails(uint _product_id) public {
        uint[] memory processed_raw = manufacturerDetailsMap[_product_id].raw_batch_no;
        uint[] memory temp;
        delete raw_products;
    ...
    function returnRawProductDetails() public returns(uint[] memory) {
        return raw_products;
    }
}